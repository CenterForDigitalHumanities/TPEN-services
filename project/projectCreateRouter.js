...
/**
 * Private function to check on items of page data
 ...
 */
function hasSuspiciousPageData(page) {
...
/**
 * Private function to check on the pages or canvases of layer data.
...
/**
 * Private function to check on tools, layers, layer.pages, and layer.pages[n].items[i] of project data.
 * They may contain data generated by direct user input, such as labels. 
 * It may be malformed, but let that be caught downstream.
 *
