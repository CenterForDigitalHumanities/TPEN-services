...
/**
 * Private function to check on items data of a page
...
router.route('/:pageId')
  ...
  .put(auth0Middleware(), screenContentMiddleware(), async (req, res) => {
    ...
    try {
      if (hasSuspiciousPageData(req.body)) return utils.respondWithError(res, 400, "Suspicious page data will not be processed.")
